...
class MetricsExporter:
    ...
    def export_to_influxdb(self, data: Dict, endpoint: str, token: str, 
    ...
    def export_to_prometheus(self, data: Dict, gateway_url: str, job: str = "network_monitor") -> bool:
        ...
        try:
            ...
            upload_gauge = Gauge('network_upload_speed_bytes', 'Upload speed in bytes/sec', registry=registry)
            download_gauge = Gauge('network_download_speed_bytes', 'Download speed in bytes/sec', registry=registry)
            latency_gauge = Gauge('network_latency_ms', 'Network latency in milliseconds', registry=registry)
            quality_gauge = Gauge('network_quality_score', 'Network quality score (0-100)', registry=registry)
            device_gauge = Gauge('network_device_count', 'Number of network devices', registry=registry)
