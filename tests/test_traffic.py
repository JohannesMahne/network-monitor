...
class TestProcessTraffic:
    ...
    def test_basic_creation(self):
        ...
        traffic = ProcessTraffic(
            pid=1234, name="Safari", bytes_in=1000000, bytes_out=500000, connections=5
        )
    ...
    def test_total_bytes_property(self):
        ...
        traffic = ProcessTraffic(pid=1, name="Test", bytes_in=100, bytes_out=200)
...
class TestServiceCategory:
    ...
    def test_basic_creation(self):
        ...
        category = ServiceCategory(
            name="Web", bytes_in=1000000, bytes_out=500000, processes=["Safari", "Chrome"]
        )
...
class TestTrafficMonitor:
    ...
    def monitor(self, mock_subprocess_cache):
        ...
        mock_subprocess_cache.run.return_value = MagicMock(returncode=0, stdout="")
...
class TestTrafficAggregation:
    ...
    def test_summary_aggregates_helpers(self, mock_traffic, monitor):
        ...
        mock_traffic.return_value = [
            ProcessTraffic(
                pid=1, name="Google Chrome", bytes_in=1000, bytes_out=500, connections=2
            ),
            ProcessTraffic(
                pid=2, name="Google Chrome Helper", bytes_in=500, bytes_out=250, connections=3
            ),
        ]
